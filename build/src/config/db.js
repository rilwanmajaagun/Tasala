...
var log = debug_1.default('database');
exports.DBConnect = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4: return [4 /*yield*/, typeorm_1.createConnection(ormconfig_1.default)];
            case 5:
                _a.sent();
                _a.label = 6;
            case 6:
...
exports.TryDBConnect = function () { return __awaiter(void 0, void 0, void 0, function () {
    var e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, exports.DBConnect()];
            case 1:
                _a.sent();
                return [2 /*return*/, 'database connected'];
            case 2:
                e_2 = _a.sent();
                console.log(e_2);
                return [3 /*break*/, 3];
